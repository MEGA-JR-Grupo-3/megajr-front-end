...
function Menu() {
  ...
  return (
    <div className="flex flex-col">
      <div className="text-center mb-6 bg-[radial-gradient(circle_at_center,var(--primary)_0%,var(--secondary)_70%)] bg-clip-text text-transparent text-3xl font-black">
        Gerencie suas tarefas
      </div>
      <div className="border border-gray-300 py-3 flex gap-1 justify-center text-center shadow-xl rounded-md">
        <button onClick={handleLogout}>
          <div className="group relative px-4 cursor-pointer">
            <div className="flex h-10 w-10 items-center justify-center rounded-full hover:text-[var(--secondary)]">
              <svg
