...
function GoogleLoginButton({ onSuccess, onError }) {
  ...
  return (
    <button
      ...
      className="inline-block cursor-pointer shadow-md transition-all duration-240 hover:[transform:translateY(-.335rem)] hover:shadow-2xl relative flex items-center justify-center mt-[13px] bg-[radial-gradient(circle_at_center,var(--primary)_0%,var(--secondary)_70%)] rounded-4xl p-2 text-[#ffffff] font-[600] w-[312px]"
    >
