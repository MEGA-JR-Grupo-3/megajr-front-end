...
function ButtonLogout() {
  return (
    <Link href="/">
      <button class="group flex items-center justify-start w-11 h-11 bg-[radial-gradient(circle_at_center,var(--primary)_0%,var(--secondary)_70%)] rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1">
